...
\begin{align}
  \det M &= {(\det\,K)}^{N_t-1} \det F_{N_t-1}^{-1} \det(F_{N_t-1} K + K^{-1} F_{N_t-2} \cdots K^{-1}F_{1}K^{-1} F_{0})\\
         &= {(\det\,K)}^{N_t-2} \det (F_{N_t-1}^{-1} F_{N_t-2}^{-1}) \det(F_{N_t-2} K F_{N_t-1} K + K^{-1} F_{N_t-3} \cdots K^{-1} F_{0})\\
         &= \Big(\prod_{t=0}^{N_t-1} \det F_{t}^{-1}\Big) \det(1 + F_0^{-1} K F_1^{-1} K \cdots F_{N_t-2}^{-1} K F_{N_t-1}^{-1} K)\\
...
% TODO can be done using the new form of the action to get directly to the "result" in terms of A^-1
