...
cla = isle.cli.init('hmc', name='basic-hmc')
...
hmcState = isle.drivers.hmc.init(lat, params, rng, makeAction, cla.outfile,
                                 cla.overwrite, startIdx=0)
...
proposer = isle.proposers.LinearStepLeapfrog(makeAction(lat, params), (1, 1), (20, 5), 99)
...
phi = hmcState(phi, proposer, 10000, saveFreq=2, checkpointFreq=10)
