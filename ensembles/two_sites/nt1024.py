...
thermalizer = isle.hmc.LinearStepLeapfrog(hamiltonian, (0.25, 0.5), (nLeapfrogTherm, nLeapfrog), nTherm-1)
proposer = isle.hmc.ConstStepLeapfrog(hamiltonian, 0.5, nLeapfrog)
